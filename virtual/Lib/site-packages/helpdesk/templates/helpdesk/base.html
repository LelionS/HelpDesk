...
<body id="bg-dark" 
style="
  background: url('https://www.transparenttextures.com/patterns/triangular.png') repeat fixed;
...
">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper"  style="margin-left: 220px; transition: margin-left 0.3s; padding: 1rem;">
